...
const Topbar = ({ toggleheure, toggleFullscreen, title }) => {
            ...
            <div className="row">
                ...
                <div className="col-2 offset-6 icons p-2">
                    <div className="row text-secondary">
                        <div className="col-3 icon d-flex justify-content-center" onClick={() => toggleFullscreen()}>
                            <i className="mdi-navigation-fullscreen mdi-2x"></i>
                        </div>
                        <div className="col-3 icon d-flex justify-content-center" onClick={() => toggleheure()}>
