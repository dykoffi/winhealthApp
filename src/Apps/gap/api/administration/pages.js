import Onglets from '../../pages/administration/_onglets'

const initState = { currentPage: Onglets[0].target || null, notification: false }
...
export const setNotification = (value) => ({ type: SET_NOTIFICATION, notification: value })
